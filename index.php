...
<?php
	...
	//SESSION merupakan data sementara
	$user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : false;
	$nama = isset($_SESSION['nama']) ? $_SESSION['nama'] : false;
	$level = isset($_SESSION['level']) ? $_SESSION['level'] : false;
	//memakai array karena dibawahnya ada fungsi count
	$keranjang = isset($_SESSION['keranjang']) ? $_SESSION['keranjang'] : array();
	//count untuk menghitung data yang didalam array
...
<html>
<head>
	<title>Online Shop | Menu Utama</title>
		...
		<div id="header">
				...
				<div id="menu">
					<div id="user">
						...
						<!-- untuk mengecek apakah ada id, jika ada maka tampilan register dan login hilang -->
						<?php
							if($user_id){
								echo "Hi <b>$nama</b>,
									  <a href='".BASE_URL."index.php?page=profile&module=pesanan&action=list'>My Profile</a>
