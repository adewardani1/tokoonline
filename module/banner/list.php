<div id="frame-tambah">
	<a class="tombol-action" href="<?php echo BASE_URL."index.php?page=profile&module=banner&action=form"; ?>">+ Tambah Banner</a>
</div>
        ...
        echo "<table class='table-list'>";
            ...
            while($rowBanner=mysqli_fetch_array($queryBanner))
            {
                echo "<tr>
                        ...
                        <td class='tengah'><a class='tombol-action' href='".BASE_URL."index.php?page=profile&module=banner&action=form&banner_id=$rowBanner[banner_id]"."'>Edit</a></td>
                     </tr>";
