<div id="frame-tambah">
	<a class="tombol-action" href="<?php echo BASE_URL."index.php?page=profile&module=kota&action=form"; ?>">+ Tambah Kota</a>
</div>
...
<?php
	...
	if(mysqli_num_rows($queryKota) == 0){
		echo "<h3>Data masih kosong, silahkan tambah data kota terlebih dahulu.</h3>";
	}
	else{
